...
use App\Http\Controllers\Api\MoniController;
use App\Http\Controllers\Api\ManagementversionController;
...
Route::get('/management_version_list', [ManagementversionController::class, 'index']);
Route::get('/moni_checknetwork', [MoniController::class, 'check_network']);

Route::middleware(['login'])->group(function () {
    Route::post('/connection_status_list', [ConnectionstatusController::class, 'index']);
    Route::post('/pull_server_data', [ConnectionstatusController::class, 'connection_status_data']);
    Route::post('/server_status_data_export', [ConnectionstatusController::class, 'export']);
   
    Route::post('/rollback_push', [RollbackController::class, 'rollbackComputer']);
    Route::get('/rollback_list', [RollbackController::class, 'index']);

    Route::post('/version_push', [VersionController::class, 'pushComputer']);
    Route::get('/version_list', [VersionController::class, 'index']);
    Route::post('/version_del', [VersionController::class, 'del']);

    Route::post('/commit_add', [CommitController::class, 'add']);
    Route::get('/commit_list', [CommitController::class, 'index']);
    Route::post('/roll_back', [CommitController::class, 'rollback_version']);

    Route::post('/server_list', [ServerController::class, 'index']);
    Route::post('/server_add', [ServerController::class, 'add']);
    Route::post('/server_del', [ServerController::class, 'del']);
    Route::post('/server_status', [ServerController::class, 'changeStatus']);
    ...
    Route::get('/check_force_logout', [IndexController::class, 'force_logout']);
